...
@Component({
  selector: 'app-buyer-dashboard-order-history',
  templateUrl: './buyer-dashboard-order-history.component.html',
  styleUrls: ['./buyer-dashboard-order-history.component.scss']
})
export class BuyerDashboardOrderHistoryComponent implements OnInit {
